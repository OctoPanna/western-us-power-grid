...
def save_data(G, edges_path="data/edges_with_attributes.csv", nodes_path="data/nodes_with_attributes.csv"):
    edges_data = []
...
def load_data_with_atributes(edges_path="data/edges_with_attributes.csv", nodes_path="data/nodes_with_attributes.csv"):
    edges = pd.read_csv(edges_path)
    nodes = pd.read_csv(nodes_path)
